    ...
    context('Footer and list of stories', () => {
      ...
      context('List of stories', () => {
        ...
        context('Order by', () => {
          ...
          it('orders by author', () => {
            cy.get('.list-header-button:contains(Author)').should('be.visible').as('authorHeader').click()
          ...
          it('orders by comments', () => {
            cy.get('.list-header-button:contains(Comments)').should('be.visible').as('commentsHeader').click()
          ...
          it('orders by points', () => {
            cy.get('.list-header-button:contains(Points)').should('be.visible').as('pointsHeader').click()
      ...
      context('Last searches', () => {
        Cypress._.times(3, () => {
          it('shows a max of 5 buttons for the last searched terms', () => {
            ...
            // utilizar quando houver um seletor muito grande
